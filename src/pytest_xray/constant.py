...
TEST_EXECUTION_ENDPOINT_MULTIPART = '/rest/raven/1.0/import/execution/multipart'
TEST_EXECUTION_ENDPOINT_CLOUD_MULTIPART = '/api/v2/import/execution/multipart'
...
ENV_TEST_EXECUTION_FIELDS = 'XRAY_EXECUTION_FIELDS'  # JSON for Jira 'fields' when creating TE via multipart